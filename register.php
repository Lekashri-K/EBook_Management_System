...
if (isset($_POST['submit'])) {
    ...
    if (strlen($password) < 8 || strlen($password)>20) {
        $password_error = "⚠️ Atleast 8 digits and atmost 20 digits";
    ...
    //         echo '<div class="alert_success">✅Registered Successfully!
    //         Click on Ok to continue<a href="profile_details.php"><button class="ok_button" style=margin-left:5px>Ok</button></a></div>';
    //     } else {
            ...
            <form action="register.php" method="post" autocomplete="off">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <center>
                                <p style="margin-left:11px;margin-top:20px">Already have an account? <a
